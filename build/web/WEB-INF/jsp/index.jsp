<%-- 
    Document   : login
    Created on : Aug 29, 2016, 3:26:38 PM
    Author     : shashi
--%>
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    ...
                    <div class="panel-body">                        
                        <form role="form" action="logincheck" method="GET">
                            <fieldset>
                              ...
                              <button type="submit" class="btn btn-lg btn-success btn-block" value="Submit">Login</button>
                              ${message}       
                            </fieldset>
                        </form>
                    </div>
               </div>
                       <form role="form" action="Signup" method="GET">     
                       <button type="submit" class="btn btn-lg btn-block warning" value="Submit1">Sign Up</button>
                       </form>
